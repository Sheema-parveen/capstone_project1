...
class Test_pimedit:  
    ...
    def test_pim_edit_employee(self,startup): 
        ...
        if(self.driver.current_url == "https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index"):
            ...
            pyautogui.write("C:\\Users\\USER\\Desktop\\sample.png.png")
            ...
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.dob).send_keys(add.Add().birth)
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.gendermale).click()
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.nickname).send_keys(add.Add().nick_name)
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.license).send_keys(add.Add().license_no)
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.license_exp).send_keys(add.Add().exp_date)
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.ssn).send_keys(add.Add().ssn_no)
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.sin).send_keys(add.Add().sin_no)
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.nationality).click()
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.national).click()
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.marital).click()
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist.marital_status).click()
            self.driver.find_element(by=By.XPATH, value=emplistloc.Emplist().saveperson).click()
            assert self.driver.find_element(by=By.CSS_SELECTOR, value=emplistloc.Emplist().save_person).click()
